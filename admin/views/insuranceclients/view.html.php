...
class InsuranceViewInsuranceclients extends JViewLegacy
{
	protected $items;
	...
	{
		$title = JText::_('COM_INSURANCE'). " - ". JText::_('COM_INSURANCE_INSURANCECLIENTS');
		JToolBarHelper::title($title , 'generic.png');
	    JToolBarHelper::custom('insuranceclients.saveGama','save.png','save.png','Update Checked Clients',true, true);
		JToolBarHelper::custom('insuranceclients.deleteGama','delete.png', 'delete.png', 'Delete Checked Clients', true, true);
