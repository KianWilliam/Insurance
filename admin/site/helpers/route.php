...
abstract class InsuranceHelperRoute
{
		public static function getInsuranceformRoute($id)
		{
					$link = 'index.php?option=com_insurance&view=insuranceform&title='. $id;
					return $link;

		}
		public static function getInsuranceagentsRoute()
		{
					$link = 'index.php?option=com_insurance&view=insuranceagents';
					return $link;
